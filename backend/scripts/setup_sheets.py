...
def setup_activities_sheet(sheet):
    ...
    data = [
        ...
        ['act_003', '갯끈풀 제거 봉사', '외래종 제거 활동', '2025-10-27', '09:00', 3, '전곡항 갯벌', 37.0681, 126.6411, 25, 100, '', 'open'],
        ['act_004', '염생식물 군락 조성', '갯벌 복원 활동', '2025-10-28', '13:00', 4, '궁평항 갯벌', 37.0392, 126.6953, 15, 100, '', 'open'],
        ['act_005', '갯벌 생태 교육', '시민 대상 갯벌 교육', '2025-10-29', '10:00', 2, '매향리 갯벌', 37.2036, 126.8290, 40, 100, '', 'open'],
    ]
